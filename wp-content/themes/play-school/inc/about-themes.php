...
<div class="wrapper-info">
	...
	<div class="col-right">			
			<div style="text-align:center; font-weight:bold;">
				<hr />
				<a href="<?php echo SKTTHEMES_LIVE_DEMO; ?>" target="_blank"><?php esc_html_e('Live Demo', 'play-school'); ?></a> | 
				<a href="<?php echo SKTTHEMES_PRO_THEME_URL; ?>"><?php esc_html_e('Buy Pro', 'play-school'); ?></a> | 
				<a href="<?php echo SKTTHEMES_THEME_DOC; ?>" target="_blank"><?php esc_html_e('Documentation', 'play-school'); ?></a>
